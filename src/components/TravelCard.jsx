...
export default function TravelCard({ record, onDelete, basePath = '' }) {
  const displayRegionId = recordRegionId(record);

  return (
    <article className="travel-card">
      <Link to={`${basePath}/region/${displayRegionId}`} className="travel-photo">
      ...
      <div className="travel-card-body">
        ...
        <div className="card-actions">
          <Link to={`${basePath}/write/${record.id}`}>수정</Link>
